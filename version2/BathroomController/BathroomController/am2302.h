...
#define SUCCESS 0
// error codes
#define BUS_NOT_FREE_ERROR 1
#define DATA_TRANSPORT_ERROR_1 2
#define DATA_TRANSPORT_ERROR_2 3
#define DATA_TRANSPORT_ERROR_3 4
#define DATA_TRANSPORT_ERROR_4 5
#define DATA_TRANSPORT_ERROR_5 6
